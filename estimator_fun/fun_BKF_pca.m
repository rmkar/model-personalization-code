function [Xs,Xs_TD] = fun_BKF_pca(msfile, tdfile, userStruct)
...
measMat_TD(:,2) = [];
measMat_TD_proj = (measMat_TD - userStruct.X0)*userStruct.W;
measMatTD = measMat_TD_proj(:,userStruct.selected_feat);
